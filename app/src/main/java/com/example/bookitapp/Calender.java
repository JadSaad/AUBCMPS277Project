...
public class Calender extends AppCompatDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        view = inflator.inflate(R.layout.activity_calender,null);
        builder.setView(view).setTitle("Choose CheckIn Date")
   ...
   @Override
    public void onAttach(Context context){
        ...
        listener = (CalenderListener)context;
